...
The computations of the different sum of squares (SSQ) values are reproduced. We start with the total sum of squares ($SSQ_T$) which corresponds to the sum of the squared deviations of the observed values for the response from the overall mean of all observations.
